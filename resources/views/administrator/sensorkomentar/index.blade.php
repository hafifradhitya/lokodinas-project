            ...
            <div class="table-responsive py-4">
                <table class="table table-bordered" id="datatable-basic">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $loop->iteration + $sensors->firstItem() - 1 }}</td>
                            <td>{{ $sensor->kata }}</td>
                            <td>{{ $sensor->ganti }}</td>
                            <td class="text-center">
                                <div class="d-flex justify-content-center">
                                    ...
                                    <button data-url="{{ route('administrator.sensorkomentar.destroy', $sensor->id_jelek) }}"
...
<script>
    $(function() {
        ...
        function updateRowNumbers() {
            let startingIndex = {{ $sensors->firstItem() - 1 }};
