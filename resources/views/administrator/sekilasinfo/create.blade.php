...
<div class="row">
    <div class="col">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('administrator.sekilasinfo.store') }}" method="post" enctype="multipart/form-data" class="form-ajax">
                    @csrf
                    ...
                    <div class="mt-4 d-flex justify-content-between">
                        ...
                        <a href="{{ route('administrator.sekilasinfo.index') }}" class="btn btn-danger">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
