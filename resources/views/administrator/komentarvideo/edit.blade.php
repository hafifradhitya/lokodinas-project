...
<div class="row">
    <div class="col">
        <div class="card card-shadow">
            ...
            <div class="card-body">
                <form action="{{ route('administrator.komentarvideo.update', $komentarvideo->id_komentar) }}" method="POST" enctype="multipart/form-data" class="form-ajax">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mt-4 d-flex justify-content-between">
                        ...
                        <a href="{{ route('administrator.komentarvideo.index') }}" class="btn btn-danger">Batal</a>
                    </div>
                </form>
            </div>
        </div>
