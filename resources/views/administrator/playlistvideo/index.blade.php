                ...
                <div class="table-responsive py-4">
                    <table class="table table-bordered" id="datatable-basic">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $loop->iteration + $playlistvideos->firstItem() - 1 }}</td>
                                <td>
                                    <?php
                                ...
                                <td class="text-center">
                                    ...
                                    <button data-url="{{ route('administrator.playlistvideo.destroy', $playvid->id_playlist) }}"
...
<script>
    $(function() {
        ...
        function updateRowNumbers() {
            let startingIndex = {{ $playlistvideos->firstItem() - 1 }};
