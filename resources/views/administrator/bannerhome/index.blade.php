                ...
                <div class="table-responsive py-4">
                    <table class="table table-bordered" id="datatable-basic">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $loop->iteration + $bannerhomes->firstItem() - 1 }}</td>
                                <td>{{ $banner->judul }}</td>
                                ...
                                <td class="text-center">
                                    <div class="d-flex justify-content-center">
                                        ...
                                        <button data-url="{{ route('administrator.bannerhome.destroy', $banner->id_iklantengah) }}"
...
<script>
    $(function() {
        ...
        function updateRowNumbers() {
            let startingIndex = {{ $bannerhomes->firstItem() - 1 }};
